...
export const BrandStory: React.FC = () => {
  return (
    <div className="bg-zinc-950 text-white py-16 px-4 sm:px-6 lg:px-8 border-t border-amber-900/30 font-sans">
      <div className="max-w-7xl mx-auto space-y-16">
        {/* Intro Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <span className="text-xs uppercase font-semibold text-amber-400 tracking-widest flex items-center gap-1.5">
              <Sparkles className="w-4 h-4" /> Legado & Alta Artesanía
            </span>
            <h2 className="font-serif text-3xl sm:text-4xl font-semibold text-amber-50 leading-tight">
              Donde el Arte de la Fragancia Encuentra la Geometría Sagrada del Tiempo
            </h2>
            <p className="text-xs sm:text-sm text-zinc-300 leading-relaxed font-light">
              Fundada bajo el principio de la inmortalidad sensorial, AURA & CHRONOS une dos tradiciones legendarias: los laboratorios de perfumería de nicho en Grasse, Francia, y la manufactura de alta relojería en Le Locle, Suiza.
            </p>
            <p className="text-xs sm:text-sm text-zinc-300 leading-relaxed font-light">
          ...
          <div className="relative aspect-[4/3] bg-zinc-900 overflow-hidden border border-amber-500/20 shadow-2xl">
            <img
              src="https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?auto=format&fit=crop&w=1200&q=80"
              alt="Atelier AURA CHRONOS"
              className="w-full h-full object-cover"
              referrerPolicy="no-referrer"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-zinc-950 via-transparent to-transparent" />
            <div className="absolute bottom-4 left-4 right-4 p-4 bg-zinc-950/80 backdrop-blur-md border border-amber-500/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-8 border-t border-zinc-900">
          <div className="p-6 bg-zinc-900/60 border border-zinc-800 space-y-3">
            <div className="w-10 h-10 bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-400">
              <Award className="w-5 h-5" />
            </div>
            <h3 className="font-serif text-base font-semibold text-amber-100">Cosecha Sustentable & Ética</h3>
          ...
          <div className="p-6 bg-zinc-900/60 border border-zinc-800 space-y-3">
            ...
            <h3 className="font-serif text-base font-semibold text-amber-100">Micromecánica de Precisión</h3>
            <p className="text-xs text-zinc-400 font-light leading-relaxed">
          ...
          <div className="p-6 bg-zinc-900/60 border border-zinc-800 space-y-3">
            ...
            <h3 className="font-serif text-base font-semibold text-amber-100">Experiencia VIP a Medida</h3>
            <p className="text-xs text-zinc-400 font-light leading-relaxed">
