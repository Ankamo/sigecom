...
export const SaasAiConcierge: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      sender: 'ai',
      text: 'Bienvenido al Concierge IA de AURA & CHRONOS. Estoy entrenado en notas olfativas de nicho, complicaciones horológicas de Ginebra y asesoría para clientes de alta sociedad. ¿En qué le asisto hoy?',
